...
// Enter your choice:
// 1
// Enter no of entries that you want to make :
// 4
// Enter a word: apple
// ENter the meaning for word : fruit
// Enter a word: bat
// ENter the meaning for word : toy
// Enter a word: jasmine
// ENter the meaning for word : flower
// Enter a word: red
// ENter the meaning for word : color
// ============OPERATIONS==========
// 1.Insert data in hash table
// 2.Display Hash Table
// 3.Delete word from Hash Table
